...
/**
 * 验证码
 * generate a random Identifying Code
 */
@SuppressWarnings("ALL")
@WebServlet(name = "IdentifyingCodeServlet", urlPatterns = "/servlet/IdentifyingCodeServlet")
public class IdentifyingCodeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //5. 往图片中写数据,将验证码存入session域
        String identifyCode =  setRandomData1(g);
        request.getSession(true).setAttribute("identifyCode",identifyCode);
    ...
    private void setRandomLine(Graphics2D g) {
    ...
    private String setRandomData(Graphics2D g) {
    ...
    private String setRandomData1(Graphics2D g) {
        StringBuilder sb = new StringBuilder();
     ...
     * @param g
     */
    private void setBackgroundColor(Graphics2D g) {
