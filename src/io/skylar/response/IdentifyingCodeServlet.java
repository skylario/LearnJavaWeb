 ...
 */
@WebServlet(name = "IdentifyingCodeServlet", urlPatterns = "/IdentifyingCodeServlet")
public class IdentifyingCodeServlet extends HttpServlet {
    ...
    private void setRandomData(Graphics2D g) {
    ...
    private void setRandomData1(Graphics2D g) {
        StringBuilder sb = new StringBuilder();
